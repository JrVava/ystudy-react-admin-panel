...
export const MediaPickerModal: React.FC<MediaPickerModalProps> = ({ onSelect, onClose }) => {
  ...
  const filteredImages = images.filter((img) => {
    ...
    return (
      (img.fileName && img.fileName.toLowerCase().includes(q)) || (img.altText && img.altText.toLowerCase().includes(q))
    );
  });
  ...
  return createPortal(
    ...
    >
      <div
        ...
        style={{ width: "100%", maxWidth: "850px", maxHeight: "90vh", overflowY: "auto", padding: "2rem" }}
      >
        <div
          style={{
            display: "flex",
