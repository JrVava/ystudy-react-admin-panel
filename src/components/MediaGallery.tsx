...
export const MediaGallery: React.FC = () => {
  ...
  const handleDeleteFolder = async (folderId: string) => {
    if (!window.confirm("WARNING: This will permanently delete the folder AND all images inside it. Are you sure?"))
      return;
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      <div
        style={{ display: "flex", gap: "0.5rem", marginBottom: "1.5rem", overflowX: "auto", paddingBottom: "0.5rem" }}
      >
        <button
                ...
                {isEditing ? (
                  ...
                  <>
                    ...
                    >
                      <Folder
                        size={14}
                        style={{ color: activeFolderId === folder._id ? "var(--primary)" : "var(--text-secondary)" }}
                      />
                      {folder.name}
                    </button>
      ...
      {isUploadModalOpen &&
        createPortal(
          ...
          >
            <div
              className="panel-glass modal-solid-bg animate-fade-in"
      ...
      {editingImage &&
        createPortal(
          ...
          >
            <div
              className="panel-glass modal-solid-bg animate-fade-in"
              style={{ width: "100%", maxWidth: "440px", maxHeight: "90vh", overflowY: "auto", padding: "2rem" }}
            >
              <div
                style={{
                  display: "flex",
