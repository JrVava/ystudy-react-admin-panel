...
export const CMSPagesAdminPanel: React.FC = () => {
  ...
  const renderField = (value: any, path: string[], label: string): React.ReactNode => {
    ...
    const isImageField =
      label.toLowerCase().includes("image") && (value === null || value === undefined || typeof value === "string");
    ...
    if (typeof value === "boolean") {
      return (
        <div
          ...
          key={path.join(".")}
          style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: "0.5rem 0" }}
        >
          ...
          <label className="switch-container">
            ...
            <span
              style={{ fontSize: "0.75rem", fontWeight: 600, color: value ? "var(--success)" : "var(--text-muted)" }}
            >
                ...
                >
                  ...
                  {isObj ? (
                    Object.keys(item)
                      ...
                      .map((subKey) => renderField(item[subKey], [...itemPath, subKey], subKey))
                  ) : (
                    <input
                      type="text"
                      value={item || ""}
      ...
      return (
        ...
        >
          ...
          {Object.keys(value)
            ...
            .map((subKey) => renderField(value[subKey], [...path, subKey], subKey))}
        </div>
      );
    }
    ...
    const isTextarea =
      typeof value === "string" &&
      (value.length > 70 || label.toLowerCase().includes("description") || label.toLowerCase().includes("content"));
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Edit page sections dynamically. Fields expand inside accordions one at a time.
          </p>
        </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
              ...
              <div>
                <h3 style={{ margin: 0, fontSize: "1.15rem", fontWeight: 700 }}>
                  Editing Page:{" "}
                  <span style={{ color: "var(--accent)", textTransform: "capitalize" }}>{editingPage.page}</span>
                </h3>
              </div>
            </div>
          ...
          {!pageData && !editorError ? (
            ...
            >
              ...
              >
                ...
                <span>
                  Page sections can be toggled open one at a time to reduce scrolling. Schema bindings are fixed.
                </span>
              </div>
              ...
              >
                ...
                >
                  ...
                  />
                  <span
                    style={{ display: "block", fontSize: "0.75rem", color: "var(--text-muted)", marginTop: "-0.5rem" }}
                  >
                ...
                {Object.keys(pageData)
                  ...
                  .map((key) => {
                    ...
                    const hasStatus =
                      sectionValue && typeof sectionValue === "object" && sectionValue.status !== undefined;
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                            ...
                            <h4
                              style={{
                                ...
                                fontSize: "1.05rem",
                                fontWeight: 700,
                                color: isSectionStatusActive ? "var(--text-primary)" : "var(--text-muted)"
                              }}
                            >
                              {formatLabel(key)}
                            </h4>
                              ...
                              <label className="switch-container">
                                ...
                                <span
                                  style={{
                                    fontSize: "0.75rem",
                                    fontWeight: 600,
                                    color: isSectionStatusActive ? "var(--success)" : "var(--text-muted)"
                                  }}
                                >
                          ...
                          >
                            {typeof sectionValue === "object" && sectionValue !== null
                              ? Object.keys(sectionValue)
                                  ...
                                  .map((subKey) => renderField(sectionValue[subKey], [key, subKey], subKey))
